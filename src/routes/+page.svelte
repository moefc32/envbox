<script>
    ...
    async function reloadEnvList() {
        try {
            const result = await ky.get('/api/env').json();
...
<main
    class="card flex flex-1 lg:m-3 bg-white w-full max-w-screen-lg rounded-none lg:rounded-lg shadow-2xl overflow-hidden"
>
